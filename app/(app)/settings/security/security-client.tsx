  ...
  return (
    <div className="space-y-6 animate-stagger">
      ...
      {setupMfa && !totpEnabled && (
        <div className="flex items-start gap-3 rounded-lg border border-amber-500 dark:border-amber-500/30 bg-amber-300 dark:bg-amber-500/10 px-4 py-3 text-sm">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {totpEnabled ? (
            <div className="flex items-center gap-3 rounded-lg border border-green-500 dark:border-green-500/20 bg-green-300 dark:bg-green-500/10 px-4 py-3">
        ...
        */}
        ...
        >
          ...
          {totpStep === 'codes' && <>
            ...
            <div className="rounded-lg border border-amber-500 dark:border-amber-500/30 bg-amber-300 dark:bg-amber-500/10 p-3">
